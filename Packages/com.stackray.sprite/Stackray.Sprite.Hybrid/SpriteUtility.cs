...
namespace Stackray.Sprite {
  public class SpriteUtility {
    ...
    private static Mesh GetMesh(UnityEngine.Sprite sprite, bool useQuad = true) {
    ...
    private static Material GetMaterial(UnityEngine.Sprite sprite, Material sourceMaterial) {
